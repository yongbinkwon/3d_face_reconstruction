...
def main(args):
    ...
    for epoch in range(epochs):
        ...
        data.set_augmentation(rotate=False, channel_scale=True, dropout=True)
...
if __name__ == '__main__':
    ...
    par.add_argument('--train_data_file', default='/lhome/yongbk/dataset/file_list_sorted.txt', type=str,
    ...
    par.add_argument('--model_path', default='checkpoint/one_image_prnet.h5', type=str,
    ...
    par.add_argument('--resume_model', default=True, type=bool,
                     help='Set if the network should resume training on a pretrained network')
    par.add_argument('--resume_model_path', default='Data/net-data/trained_fg_then_real.h5', type=str,
